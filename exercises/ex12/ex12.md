...
--The threads are running concurrently. Syncronization errors do occur - the value of the counter being read is not necessarily the correct value as the counter is being written and read.
